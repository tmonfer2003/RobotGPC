...
function loadScene() {
    ...
    bisagra = new THREE.Mesh(new THREE.BoxGeometry(0.1,0.1,10), new THREE.MeshNormalMaterial());
    bisagra.position.x=2.5;
    bisagra.position.y=0.5;
    caja1.add(bisagra);
